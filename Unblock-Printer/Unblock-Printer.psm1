function Unblock-Printer {
    <#
    .SYNOPSIS
        Unblocks all printers installed on a given (list) of ComputerName.
        If no -ComputerName is provided it will default to the localhost.
    .EXAMPLE
        Unblock-Printer -ComputerName localhost,PC01
    #>
                ...
                If ((Test-CIMPing -ComputerName $Computer).Success) {
                    ...
                    $ScriptBlock = {
                        ...
                        foreach ($printprocessor in $PrintProcessors) {
                            $newname = $printprocessor.PSChildName + ".old"
                    ...
                    if ($PSCmdlet.ShouldProcess("$Computer", "Unblock-Printer")) {
