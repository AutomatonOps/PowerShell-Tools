...
Function New-ProgressBar 
{
    ...
    $ProgressSize = @{"Small"=120;"Medium"=280;"Large"=560}
    ...
    $syncHash.XAML = @" 
        <Window 
            ...
            Width = "$($ProgressSize[$Size]+75)" SizeToContent = "Height" ShowInTaskbar = "True" WindowStyle = "None"
...
"@
               ...
               <TextBlock Name="Status" Text="" HorizontalAlignment="Center" TextWrapping="Wrap" />
